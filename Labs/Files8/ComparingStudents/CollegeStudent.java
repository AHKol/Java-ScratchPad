...
public class CollegeStudent extends Student {
	...
	public static void main(String[] args) {
		CollegeStudent[] cs = { new CollegeStudent("Abe", "Vu", 35, 123321),
				new CollegeStudent("Eric", "Marx", 34, 234432),
				new CollegeStudent("Cuong", "Marx", 34, 456654),
				new CollegeStudent("Oscar", "Savage", 35, 987789),
				new CollegeStudent("John", "Savage", 34, 876678) };

		List<CollegeStudent> list = Arrays.asList(cs);
		Collections.sort(list, STUDENT_ORDER);// What if we had said: "Collections.sort(list);" instead?
